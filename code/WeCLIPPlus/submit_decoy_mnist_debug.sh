...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsMNIST/decoy_mnist_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsMNIST/decoy_mnist_%j.err
...
SETUP_DATA=1
SORT_BY_LABEL=0
RESULTS_DIR="results_decoy_mnist"
