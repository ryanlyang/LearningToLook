...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsMeat/redmeat_openclip_laion_dinovit_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsMeat/redmeat_openclip_laion_dinovit_%j.err
