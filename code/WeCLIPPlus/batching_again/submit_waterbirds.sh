...
#SBATCH --mem=64G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterSwitch/waterbirds_95_seg_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterSwitch/waterbirds_95_seg_%j.err
