...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsDINO/clear_test_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsDINO/clear_test_%j.err
...
# Also clear torch hub checkpoints cache
echo "Clearing torch hub checkpoints..."
