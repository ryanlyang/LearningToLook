...
#SBATCH --mem=64G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterSwitch/siglip2_waterbirds_100_seg_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterSwitch/siglip2_waterbirds_100_seg_%j.err
...
cd /home/ryreu/guided_cnn/waterbirds/newCLIP/L100/LearningToLook/code/WeCLIPPlus
...
srun --unbuffered python -u generate_pseudo_masks_waterbirds.py \
  --setup-data \
  --repo-root "/home/ryreu/guided_cnn/waterbirds/newCLIP/L100/LearningToLook" \
