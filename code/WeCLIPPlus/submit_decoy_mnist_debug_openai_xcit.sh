...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsMNIST/decoy_mnist_openai_xcit_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsMNIST/decoy_mnist_openai_xcit_%j.err
