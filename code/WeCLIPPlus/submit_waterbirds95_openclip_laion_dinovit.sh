...
#SBATCH --mem=32G
#SBATCH --output=/home/ryreu/guided_cnn/logsWaterSwitch/waterbirds95_openclip_laion_dinovit_%j.out
#SBATCH --error=/home/ryreu/guided_cnn/logsWaterSwitch/waterbirds95_openclip_laion_dinovit_%j.err
...
SRC_IMG_DIR="/home/ryreu/guided_cnn/waterbirds/waterbird_complete95_forest2water2"

CONDA_ENV="learntolook"
CLASS_NAME="bird"
RESULTS_DIR="results_waterbirds95_openclip_laion_dinovit"
VOC_WORKSPACE_NAME="${VOC_WORKSPACE_NAME:-VOC2012_waterbirds95}"
